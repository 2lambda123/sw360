...
public class EccPortlet extends Sw360Portlet {
    ...
    public JSONArray getReleaseData(List<Release> releaseList, PaginationParameters releaseParameters, ResourceRequest request) {
        ...
        for (int i = start; i < count; i++) {
            ...
            jsonObject.put("status", release.getEccInformation().getEccStatus());
    ...
    public static Comparator<Release> compareByName(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getName()));
        return isAscending ? comparator : comparator.reversed();
    }

    public static Comparator<Release> compareByVersion(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getVersion()));
        return isAscending ? comparator : comparator.reversed();
    }
    
    public static Comparator<Release> compareByCreatorGroup(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getCreatorDepartment()));
        return isAscending ? comparator : comparator.reversed();
    }
    
    public static Comparator<Release> compareByAssessorContactPerson(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getEccInformation().getAssessorContactPerson()));
        return isAscending ? comparator : comparator.reversed();
    }
    
    public static Comparator<Release> compareByAssessorDept(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getEccInformation().getAssessorDepartment()));
        return isAscending ? comparator : comparator.reversed();
    }
    
    public static Comparator<Release> compareByAssessmentDate(boolean isAscending) {
        Comparator<Release> comparator = Comparator.comparing(r -> nullToEmptyString(r.getEccInformation().getAssessmentDate()));
        return isAscending ? comparator : comparator.reversed();
    }
